...
// Fri Apr 29 10:08:09 2022 by ROOT version 6.24/06
// from TTree Analysis/Analysis
// found on file: Digitizer/Analysis_root/Analysis_W15_boxes15_Run8_x_0_720_y_0_780_250V_2padfloating.root
//////////////////////////////////////////////////////////

#ifndef RSD2_Digitizer_boxes15_h
#define RSD2_Digitizer_boxes15_h
...
class RSD2_Digitizer_boxes15 : public TSelector {
public :
   ...
   Double_t TDelay[20];
   Double_t TChannel[20];
   Double_t Tcor5,Tcor6, Tcor7, Tcor8, TTrigger, EventTime, TNum, TDen; 

   Double_t XRecArray[9000];
   Double_t YRecArray[9000];
   Double_t TRecArray[9000];

   Double_t XTrueArray[9000];
   Double_t YTrueArray[9000];
...
#define PI 3.14159265
   ...
   Int_t Xm1,Xm2,Xm3, Xp1,Xp2, Xp3, Ym1,Ym2,Yp1,Yp2, Ypp1, Ypp2, Xm0, Ym0;
   ...
   Double_t XPa[18] = {0,609,0,263,436,263,90,90,90,609,0,0,609,263,436,436,0,0};
   Double_t YPa[18] = {0,180,0,180,80,380,80,280,480,580,0,0,380,580,480,280,0,0};


   Double_t x_true[9000], y_true[9000], x_rec[9000], y_rec[9000],x_rec0[9000], y_rec0[9000],t_rec[9000];
   Double_t dif, dif_min, cor_x,cor_y, cor_nx,cor_d,cor_ny;
   Double_t  dif_minx, dif_miny, Radius_r, XCent, YCent, Noise;
   Int_t grid = 15;
   Int_t res = 0;
   Int_t res_min = 0;
   Int_t sim_point = 0;
   ...
   Double_t Yarmlenght = 90;
   Double_t Xarmwidth = 5;

   Double_t Xarmlenght = 150;
   Double_t Yarmwidth = 5;
   ...
   Int_t  RunNumber;
   Int_t Correction;
   Int_t LaserPointInside[9000];

   Int_t DataCorPointInside[9000];
   ...
   RSD2_Digitizer_boxes15(TTree * /*tree*/ =0) { }
   virtual ~RSD2_Digitizer_boxes15() { }
   ...
   ClassDef(RSD2_Digitizer_boxes15,0);

};

#endif

#ifdef RSD2_Digitizer_boxes15_cxx
void RSD2_Digitizer_boxes15::Init(TTree *tree)
{
...
Bool_t RSD2_Digitizer_boxes15::Notify()
{
...
#endif // #ifdef RSD2_Digitizer_boxes15_cxx
